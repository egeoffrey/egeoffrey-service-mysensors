...
To validate the installation, got and visit the *'eGeoffrey Admin'* / *'Packages'* page of your eGeoffrey instance.
## Content
...
```
egeoffrey-cli build egeoffrey-service-mysensors <amd64|arm>
```
...
The version of this egeoffrey-service-mysensors is 1.0-13 (development).
